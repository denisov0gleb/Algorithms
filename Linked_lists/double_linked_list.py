...
if __name__ == "__main__":
    ...
    DLL.insert_at_start("Two")
    DLL.insert_at_start("one")
    DLL.insert_at_end("three")
    DLL.insert_at_index("zero", 0)
    DLL.insert_at_index("garbage", DLL.get_length())
    DLL.print_all() # zero (0) -> one (1) -> Two (2) -> three (3) -> garbage (4) -> None 
    DLL.remove_at_index(4)
    DLL.update_at_index("two", 2)
    DLL.print_all() # zero (0) -> one (1) -> two (2) -> three (3) -> None